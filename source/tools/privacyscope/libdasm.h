...
typedef struct _OPERAND {
	...
	short  section;		// Section prefix value
	unsigned int displacement;	// Displacement value
	unsigned int  immediate;	// Immediate value
...
typedef struct _INSTRUCTION {
	...
	unsigned char opcode;		// Actual opcode
...
int get_instruction(
	...
	unsigned char *addr,		// code buffer
...
int get_instruction_string(
	...
	unsigned int offset,		// instruction absolute address
...
int get_operand_immediate(
	POPERAND op,
	unsigned int *imm		// returned immediate value
);
int get_operand_displacement(
	POPERAND op,
	unsigned int *disp		// returned displacement value
);
